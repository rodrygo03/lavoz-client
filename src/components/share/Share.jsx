...
const Share = ({categ}) => {
  ...
  const handleClick = async (e) => {
    ...
    setError(false);
    setDisplayMessage(0);
    mutation.mutate({ desc: descEntry, img0: imgUrls[0], img1: imgUrls[1], img2: imgUrls[2], img3: imgUrls[3], img4: imgUrls[4], img5: imgUrls[5], img6: imgUrls[6], img7: imgUrls[7], img8: imgUrls[8], img9: imgUrls[9], category, gifUrl: gif, hasFlag: flag });
    setGif(null);
    setCategory(categ);
    setFlag(false);
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="content" style={{minHeight: "30%"}}>
          <div className="row">
            <Link to={"/register"}>
...
//     setError(false);
//     setDisplayMessage(0);
//     mutation.mutate({ desc, img: imgUrl, category, gifUrl: gif, hasFlag: flag });
//     setDesc("");
//     setFile(null);
//     setGif(null);
//     setCategory(null);
...
//   console.log('Current desc state:', desc);
...
//           {file && (
//             <>
//             <button className="x" style={{marginLeft: 300}} onClick={() => handleX()}>
//               <DisabledByDefault style={{color: 'gray'}}/>
//             </button>
//               {file.type.startsWith("image/") ? (
...
//               <label>
//                 <div className="item">
//                   <img className="file" src={Tamu} onClick={()=>setFlag(!flag)}/>
//                   <span>{t('share.flag')}</span>
//                 </div>
//               </label>
//             }
