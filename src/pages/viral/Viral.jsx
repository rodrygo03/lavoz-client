  ...
  return (
    <div className="viral">
        <div className="section" style={{display: "flex", justifyContent: "center", padding: 30 }}>
            {i18next.language == 'en' ? 
            <iframe width="350" height="700" src="https://rss.app/embed/v1/carousel/zSH4hCtsZz0XJDmA" frameborder="0"></iframe>
            :
            <iframe width="350" height="700" src="https://rss.app/embed/v1/carousel/NYJw8aOMWIZClNzi" frameborder="0"></iframe>
            }
        </div>
    </div>
  )
