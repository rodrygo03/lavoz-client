...
const StudyGroups = ({ onBack }) => {
  ...
  const handleCreateGroup = (e) => {
    ...
    const groupData = {
      ...
      time: newGroup.time,
      members: 1,
      maxMembers: parseInt(newGroup.maxMembers, 10) || 10,
    };
              ...
              filteredGroups.map((group) => (
                <div key={group.id} className="study-group-card">
                  ...
                  <div className="group-actions">
                    <button className="join-btn" disabled={group.members >= group.maxMembers}>
                      {group.members >= group.maxMembers ? t("studyGroups.full") : t("studyGroups.joinGroup")}
                    </button>
                  </div>
                </div>
              ))
