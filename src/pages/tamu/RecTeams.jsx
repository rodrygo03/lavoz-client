...
const RecTeams = ({ onBack }) => {
  ...
  const filteredTeams = recTeams.filter(team => {
    ...
    const matchesSkillLevel = selectedSkillLevel === "" || selectedSkillLevel === "All" || team.skillLevel === selectedSkillLevel;
  ...
  const handleCreateTeam = (e) => {
    ...
    const teamData = {
      ...
      members: 1,
      maxMembers: parseInt(newTeam.maxMembers) || 15,
              ...
              filteredTeams.map(team => (
                <div key={team.id} className="rec-team-card">
                  ...
                  <div className="skill-level">
                    ...
                    <span>{team.skillLevel} {getSkillLevelIcon(team.skillLevel)}</span>
                  </div>
