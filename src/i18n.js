    ...
    resources: {
      en: {
        translation: {
          ...
          socialHub: {
            title: "Social Hub",
            tagline: "Connect, collaborate, and have fun with fellow Aggies!",
            studyGroups: "Find Study Group",
            studyGroupsDesc: "Join or create study groups for your classes",
            recTeams: "Join a Rec Team",
            recTeamsDesc: "Find recreational sports teams and activities",
            discords: "Browse Discords",
            discordsDesc: "Discover Discord servers for gaming, study, and TAMU orgs",
          },
          otherPages: {
      ...
      es: {
        translation: {
          ...
          socialHub: {
            title: "Centro Social",
            tagline: "¡Conecta, colabora y diviértete con otros Aggies!",
            studyGroups: "Buscar Grupo de Estudio",
            studyGroupsDesc: "Únete o crea grupos de estudio para tus clases",
            recTeams: "Unirse a un Equipo Recreativo",
            recTeamsDesc: "Encuentra equipos deportivos recreativos y actividades",
            discords: "Explorar Discords",
            discordsDesc: "Descubre servidores de Discord para gaming, estudio y organizaciones TAMU",
          },
          otherPages: {
